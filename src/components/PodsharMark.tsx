 ...
 * so it works on any surface in either palette.
 *
 * Still the app icon and the wordmark. It is no longer the assistant's face —
 * that is the photo in `AssistantAvatar`, which falls back to this mark.
 */
