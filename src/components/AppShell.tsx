      ...
      <div className="flex min-w-full flex-1 flex-col lg:min-w-0">
        ...
        <header className="flex items-center justify-between border-b border-rule px-3 py-3 sm:px-4">
          <button
            ...
            className="group flex h-11 w-11 flex-col items-center justify-center gap-[5px] rounded border-2 border-rule transition-colors duration-drape ease-drape hover:bg-sunk"
          >
            <span className="h-0.5 w-4 bg-ink transition-all duration-drape ease-drape group-hover:w-5" />
            <span className="h-0.5 w-4 bg-ink transition-all duration-drape ease-drape group-hover:w-3" />
            <span className="h-0.5 w-4 bg-ink transition-all duration-drape ease-drape group-hover:w-5" />
          </button>
