...
Hub page, profile editing, avatar upload, the media pipeline and `/api/media`
proxy. Gallery upload and browsing. Gallery CAPTCHA on the login form.
...
*Exit:* the hub is worth opening daily.
